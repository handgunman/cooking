...
-- ReadFromMergeTree (prj_agg_by_category_country)
```
...
-- ReadFromMergeTree (prj_agg_by_account)
```
...
-- ReadFromMergeTree (prj_order_by_risk)
```
...
-- Parts: 37/114   <- чем меньше левое число, тем лучше работает индекс
-- Granules: 2949/6149
```
